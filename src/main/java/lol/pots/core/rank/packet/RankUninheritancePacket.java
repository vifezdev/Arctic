...
@Getter
@Setter
public class RankUninheritancePacket extends Packet {
    ...
    public RankUninheritancePacket(String parent, String child) {
        this.parent = parent;
        this.child = child;
    }
    ...
    public void onReceive() {
        Rank rank = rankHandler.getRankByName(parent);
        rank.getInheritances().remove(child);
