...
public class TogglePrivateMessagesCommand {
    ...
    @Command(name = "", desc = "toggles private messages")
    public void execute(@Sender CommandSender sender) {
        ...
        profile.save();
        String context = profile.getSettings().isPrivateMessages() ? "&aenabled" : "&cdisabled";
        String message = "&bYou've &r{context} &byour private messages.";
