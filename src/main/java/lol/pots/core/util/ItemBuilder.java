...
public class ItemBuilder {
    ...
    public ItemBuilder(ItemStack item) {
        ...
        if (item.hasItemMeta()) flags.addAll(item.getItemMeta().getItemFlags());
    }
     ...
     *
     * @param name Displayname for the ItemStack
     */
    public ItemBuilder name(String name) {
        Validate.notNull(name, "The Displayname is null.");
        this.name = andSymbol ? ChatColor.translateAlternateColorCodes('&', name) : name;
        return this;
    }
