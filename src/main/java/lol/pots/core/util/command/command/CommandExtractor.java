...
import lol.pots.core.util.command.exception.CommandRegistrationException;
import lol.pots.core.util.command.exception.CommandStructureException;
import lol.pots.core.util.command.exception.MissingProviderException;
