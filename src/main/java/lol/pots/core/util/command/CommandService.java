package lol.pots.core.util.command;

import org.bukkit.plugin.java.JavaPlugin;
import lol.pots.core.util.command.annotation.Command;
import lol.pots.core.util.command.annotation.Modifier;
import lol.pots.core.util.command.command.DrinkAuthorizer;
import lol.pots.core.util.command.command.DrinkCommandContainer;
